package com.example.tugasskripsi.viewmodel
...
import com.example.tugasskripsi.TugasSkripsiApplication
import com.example.tugasskripsi.data.User
import com.example.tugasskripsi.util.RegisterValidation
import com.example.tugasskripsi.util.Resource
import com.example.tugasskripsi.util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<TugasSkripsiApplication>().contentResolver,
                    imageUri
                )
