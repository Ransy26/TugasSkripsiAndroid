...
import com.example.tugasskripsi.adapters.CartProductAdapter
import com.example.tugasskripsi.databinding.FragmentCartBinding
import com.example.tugasskripsi.firebase.FirebaseCommon
import com.example.tugasskripsi.util.Resource
import com.example.tugasskripsi.util.VerticalItemDecoration
import com.example.tugasskripsi.viewmodel.CartViewModel
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.deleteDialog.collectLatest {
                val alertDialog = AlertDialog.Builder(requireContext()).apply {
                    setTitle("Hapus item dari keranjang")
                    setMessage("Apakah anda ingin menghapus item dari keranjang?")
